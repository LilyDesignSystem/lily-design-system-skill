...
This repository is a Claude Skill packaging Lily Design System documentation for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-skill.git
```
